  ...
  const testimonials = [
    {
      ...
      rating: 5,
      earnings: "₹15,680",
      text: "I've been playing competitive BGMI for months here. The platform is legit and payouts are instant! Made over ₹15K last month alone.",
      verified: true,
    },
    {
      id: 2,
    ...
    },
    {
      ...
      rating: 5,
      earnings: "₹22,340",
      text: "Best gaming platform I've used! Manual verification ensures no cheaters. Won ₹22K in 3 months. Customer support is also excellent.",
      verified: true,
    },
    {
      id: 4,
    ...
    },
    {
      ...
      rating: 5,
      earnings: "₹18,920",
      text: "Love the transparency here. Every match is fair, results are verified manually. Earned ₹18K+ and still going strong!",
      verified: true,
    },
    {
      id: 6,
